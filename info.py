...
# Auto Delete Feature
AUTO_DELETE = True        # enable/disable auto delete
DELETE_TIME = 300         # time in seconds (300 = 5 minutes)
DELETE_MESSAGE = True     # send message after deletion
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002448390763 -1002255066315 -1002917124625').split()]
